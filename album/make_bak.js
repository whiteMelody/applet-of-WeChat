            ...
            wx.request({
                ...
                success: (res) => {
                    ...
                    if (res.data.ret == 200) {
                        ...
                        _tmp[commentVal.index].comments = res.data.data
            ...
            wx.request({
                ...
                success: (res) => {
                    ...
                    if (res.data.ret == 200) {
                        ...
                        _tmp[ReplyVal.index].comments = res.data.data
    ...
    onShareAppMessage(e){
        if(e.from == 'button'){
            ...
            return {
                ...
                path: '/pages/join/join?dynamic_id=' + e.target.dataset.id,
