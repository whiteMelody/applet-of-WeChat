...
App({
  ...
  //         //发起网络请求
  //         wx.request({
  //           url: this.globalData.requestUrl + 'exam/getpaper',
  //           header: {
  ...
  globalData: {
    // requestUrl: 'http://school.sfsoft.vip/api/',           //测试
    requestUrl: 'https://znz.onebopay.com/api/',           //指南针
    requestUrl2: 'https://ch.onebopay.com/api/',           //派答星
    userInfo: {},
  },

  checkOrder(openId, out_trade_no){

    setTimeout(()=>{
      wx.request({
        url: this.globalData.requestUrl + 'prepay/checkorder',
        header: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
